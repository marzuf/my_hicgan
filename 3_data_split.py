...
logFile = os.path.join(out_dir, file_prefix + "_split_lr_hr_hic_logFile.txt")
...
def hic_matrix_extraction(inDir,filePrefix, hr_fileSuffix, lr_fileSuffix, chrSizeDict, binSize, idxInBin=True):
    ...
    print("... HR matrix built from:\t" + hr_hic_file)


    hr_contacts_dictFile = os.path.join(out_dir, file_prefix + "_" + chromo +"_hr_contacts_dict.hkl")
    hkl.dump(hr_contacts_dict, hr_contacts_dictFile)
    print("... written: " + hr_contacts_dictFile)
    ...
    print("... LR matrix built from:\t" + hr_hic_file)

    lr_contacts_dictFile = os.path.join(out_dir, file_prefix + "_" + chromo +"_lr_contacts_dict.hkl")
    hkl.dump(lr_contacts_dict, lr_contacts_dictFile)
    print("... written: " + lr_contacts_dictFile)
...
lr_contacts_dictFile = os.path.join(out_dir, file_prefix + "_lr_contacts_dict.hkl")
hkl.dump(lr_contacts_dict, lr_contacts_dictFile)
print("... written: " + lr_contacts_dictFile)

hr_contacts_dictFile = os.path.join(out_dir, file_prefix + "_hr_contacts_dict.hkl")
hkl.dump(hr_contacts_dict, hr_contacts_dictFile)
print("... written: " + hr_contacts_dictFile)
...
nb_hr_contactsFile = os.path.join(out_dir, file_prefix + "_nb_hr_contacts.hkl")
hkl.dump(nb_hr_contacts, nb_hr_contactsFile)
print("... written: " + nb_hr_contactsFile)

nb_lr_contactsFile = os.path.join(out_dir, file_prefix + "_nb_lr_contacts.hkl")
hkl.dump(nb_lr_contacts,nb_lr_contactsFile)
print("... written: " + nb_lr_contactsFile)


# WRITE MAX CONTACT FILES
max_hr_contact_normFile = os.path.join(out_dir, file_prefix + "_max_hr_contact_norm.hkl")
hkl.dump(max_hr_contact_norm,max_hr_contact_normFile)
print("... written: " + max_hr_contact_normFile)

max_lr_contact_normFile = os.path.join(out_dir, file_prefix + "_max_lr_contact_norm.hkl")
...
train_data_file = os.path.join(out_dir, file_prefix + "_train_data.hkl")
hkl.dump([lr_mats_train,hr_mats_train,distance_train], train_data_file)
print("... written: " + train_data_file)

test_data_file = os.path.join(out_dir, file_prefix + "_test_data.hkl")
